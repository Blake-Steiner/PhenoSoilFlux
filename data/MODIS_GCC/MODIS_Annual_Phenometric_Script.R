...
setwd("F:/2019_Data_MS/Pheno_GPP_SWC_paper_redo/Manuscript_Code_Submission/data/MODIS_GCC/")
...
fit_modis_annual <- lapply(seq_along(zoo_modis_annual_data), 
                           function(x) greenProcess(zoo_modis_annual_data[[x]],
                                                    fit = 'spline', # what curve fitting should be used
                                                    threshold =  'gu', # method for thresholds
                                                    plot = TRUE,
